const features = {
  pc: require('../rpg-data/data/pc/common/features.json'),
  bedrock: require('../rpg-data/data/bedrock/common/features.json')
}

module.exports = (versionObj, allVersions) => {
  // Keep a dictionary of majorVersion => oldest / newest release
  // Relies on descending order in rpg-data's protocolVersions list
